...
$query = "SELECT sid, firstname, lastname, photo, email, phoneno, address, department, faculty, lid, password FROM student WHERE sid = '{$_SESSION['sid']}'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['photo']['name'])) {
        ...
        if (move_uploaded_file($tmpFilePath, $targetFilePath)) {
            ...
            $updatePhotoQuery = "UPDATE student SET photo = '$photo' WHERE sid = '$sid'";
    ...
    $updateQuery = "UPDATE student SET email = '$newEmail', phoneno = '$newPhoneNo', address = '$newAddress', department = '$newDepartment', faculty = '$newFaculty', password = '$newPassword' WHERE sid = '$sid'";
