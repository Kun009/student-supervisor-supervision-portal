...
$query = "SELECT firstname FROM student WHERE sid = '{$_SESSION['sid']}'";
...
// Check if the student has any unread messages
$unreadQuery = "SELECT COUNT(*) AS unreadCount FROM messages WHERE recipient_id = '{$_SESSION['sid']}' AND is_read = 0";
...
<div class="header">
    ...
    <div class="header-left">
        <a href="dashboard.php" class="logo">
            ...
            <span style="font-size: 14px;">University of Greenwich</span> 
        </a>
			...
			<div class="dropdown-menu">
							<div class="sid-header">
								<div class="avatar avatar-sm">
									<img src="assets/img/profiles/avatar-01.png" alt="sid Image" class="avatar-img rounded-circle">
								</div>
								<div class="sid-text">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
                            ...
                            <a href="supervisor.php"><i class="fe fe-sid-plus"></i> <span>Supervisor</span></a>
                            <a href="proposal.php"><i class="fe fe-edit"></i> <span>Proposal</span></a>
<a href="idea.php"><i class="fe fe-sunrise"></i> <span>Project Ideas</span></a>
