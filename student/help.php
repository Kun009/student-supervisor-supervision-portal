...
function insertComplaint($con, $complaintType, $complaintMessage)
{
    ...
    $query = "INSERT INTO complaints (sid, complaint_type, complaint_message) VALUES ('$sid', '$complaintType', '$complaintMessage')";
...
function getStudentComplaints($con, $sid)
{
    $query = "SELECT * FROM complaints WHERE sid = '$sid'";
    $result = mysqli_query($con, $query);
    $complaints = array();
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $sid = $_SESSION['sid'];
                                        $studentComplaints = getStudentComplaints($con, $sid);
