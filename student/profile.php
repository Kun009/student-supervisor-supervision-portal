...
// Assuming you have a database connection, execute a query to fetch the student details
// Modify this query according to your database structure and table names
$query = "SELECT sid, firstname, lastname, photo, email, phoneno, address, department, faculty, lid FROM student WHERE sid = '{$_SESSION['sid']}'";
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Supervisor ID:</strong> <?php echo $lid; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
