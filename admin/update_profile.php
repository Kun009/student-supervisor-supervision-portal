...
$query = "SELECT aid, firstname, lastname, photo, email, phoneno, address, aid, password FROM admin WHERE aid = '{$_SESSION['aid']}'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Vaaidate and process the profile picture upload if a new image is selected
    if (!empty($_FILES['photo']['name'])) {
        ...
        if (move_uploaded_file($tmpFilePath, $targetFilePath)) {
            ...
            $updatePhotoQuery = "UPDATE admin SET photo = '$photo' WHERE aid = '$aid'";
    ...
    $updateQuery = "UPDATE admin SET email = '$newEmail', phoneno = '$newPhoneNo', address = '$newAddress',  password = '$newPassword' WHERE aid = '$aid'";
