...
$query = "SELECT firstname FROM lecturer WHERE lid = '{$_SESSION['lid']}'";
...
$unreadQuery = "SELECT COUNT(*) AS unreadCount FROM messages WHERE recipient_id = '{$_SESSION['lid']}' AND is_read = 0";
...
<a href="student.php"><i class="fe fe-book"></i> <span>Student</span></a>
