...
if(isset($_REQUEST['insert']))
{
	...
	{
		$sql="insert into admin (lid,aemail,apassword,adob,aphone) values('$name','$email','$password','$dob','$phone')";
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form method="post">
									...
									<div class="form-group">
										<input class="form-control" type="text" placeholder="passwordword" name="password">
									</div>
									<div class="form-group">
